...
Shader "SpeedLineLitHDRP"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SpeedLinesUtility.hlsl"
            #pragma vertex SpeedLineVert      
        ...
        Pass
        {
            ...
            //#include "./Common/CustomVertex.hlsl"
        ...
        Pass
        {
            ...
            #include "SpeedLinesUtility.hlsl"
            #pragma vertex SpeedLineVertWithFreq   
            #pragma fragment SpeedLineFragWithFreq     
